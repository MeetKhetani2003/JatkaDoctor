    ...
    const fetchDoctors = async () => {
      try {
        ...
        if (Array.isArray(data) && data.length > 0) {
          ...
          setDoctors(
            staticTeam.filter((m) => m.category === "Doctors").slice(0, 8),
          );
        }
      } catch (e) {
        setDoctors(
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-end mb-8">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-normal text-black tracking-tight">
              Our Medical Team
            </h2>
            <p className="text-gray-500 text-sm mt-2 font-normal">
              Expert Doctors, Nurses & Technicians for Home Care
            </p>
          </div>
          <Link
            href="/our-medical-team"
            className="hidden sm:flex items-center gap-1 text-primary text-sm font-normal"
          >
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-1">
                  <div className="flex justify-between items-start mb-1">
                    <h3 className="text-lg font-normal text-black leading-tight truncate mr-2 group-hover:text-primary transition-colors">
                      {member.name}
                    </h3>
                  ...
                  <p className="text-primary text-xs font-normal mb-2">
                    {member.role}
                  </p>
