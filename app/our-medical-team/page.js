...
import { User, ChevronLeft, Search, Filter, Phone, MessageSquare, Star, Clock, MapPin, CheckCircle2 } from 'lucide-react';
...
const categories = ["All", "Doctors", "Nurses", "Technicians", "Caregivers"];
      ...
      <div className="max-w-7xl mx-auto px-5 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {filteredTeam.map((member) => (
            <div 
              key={member.id} 
              className="bg-white rounded-[32px] p-5 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col"
            >
              <div className="flex items-center gap-4 mb-5">
                ...
                <div className="flex-1 overflow-hidden">
                  <div className="flex items-center justify-between mb-1">
                    <h3 className="text-base font-normal text-black truncate leading-tight">{member.name}</h3>
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  <Phone className="w-4 h-4" /> Book Appointment Now
                </a>
                <a 
