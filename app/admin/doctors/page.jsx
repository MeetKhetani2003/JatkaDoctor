...
export default function AdminDoctors() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingDoctor ? `/api/doctors?id=${editingDoctor._id}` : '/api/doctors';
      ...
      if (res.ok) {
        ...
        fetchData();
        setFormData({ name: '', category: '', role: '', degree: '', experience: '', area: '', isVerified: true, image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&h=400&fit=crop', description: '', specialization: '' });
      }
    } catch (e) {
  ...
  const handleEdit = (doctor) => {
    ...
    setFormData({
      ...
      image: doctor.image || 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&h=400&fit=crop',
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                <th className="px-6 py-4 text-xs font-normal text-gray-500 uppercase tracking-wider">Name</th>
                <th className="px-6 py-4 text-xs font-normal text-gray-500 uppercase tracking-wider">Role / Specialization</th>
                <th className="px-6 py-4 text-xs font-normal text-gray-500 uppercase tracking-wider">Area</th>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-gray-400">{doctor.degree || doctor.experience}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-600">{doctor.role}</td>
                    <td className="px-6 py-4 text-sm text-gray-600">{doctor.area || 'N/A'}</td>
                    <td className="px-6 py-4">
          ...
          <div className="bg-white rounded-[32px] w-full max-w-2xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-5 max-h-[70vh] overflow-y-auto">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-normal text-gray-400 uppercase tracking-wider ml-1">Service Area</label>
                  <input 
                    value={formData.area}
                ...
                <div className="flex items-center gap-3 pt-6">
                  ...
                  />
                  <label htmlFor="isVerified" className="text-sm font-normal text-gray-600">Verified by Dr. Jhatka</label>
                </div>
              </div>

              <div className="space-y-1.5">
                <label className="text-xs font-normal text-gray-400 uppercase tracking-wider ml-1">Profile Image URL</label>
                <input 
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-normal text-gray-400 uppercase tracking-wider ml-1">Degree (Optional)</label>
                <input 
