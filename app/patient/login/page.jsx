    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl text-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Dr Jhatka Medicare</h1>
          <p className="text-blue-200/70 text-sm mb-8">Sign in to view your therapy sessions & bookings</p>
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 w-full px-6 py-3.5 bg-white text-gray-800 font-semibold rounded-xl hover:bg-gray-50 transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
          >
        ...
        <div className="text-center mt-6">
          <a href="/" className="text-blue-300/60 text-sm hover:text-blue-300 transition-colors">
            ← Back to homepage
          </a>
        </div>
      </div>
