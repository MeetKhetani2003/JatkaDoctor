...
const TherapySessionSchema = new mongoose.Schema({
  ...
  // Attendance Tracking
  attendanceStatus: { type: String, enum: ['Present', 'Absent', 'Holiday', ''], default: '' },
  sessionDate: { type: String }, // Actual date when session occurred
  notes: { type: String }, // Admin notes for this session
